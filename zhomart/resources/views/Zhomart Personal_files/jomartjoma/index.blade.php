					...
					<ul class="nav-menu">
						...
						<li class="menu-has-children"><a href="#">Pages</a>
							<ul>
								...
								<li><a href="index.html">Portfolio Details</a></li>
							</ul>
						</li>
						<li class="index.html"><a href="">Blog</a>
							<ul>
		...
		<div class="container">
			<div class="row fullscreen d-flex align-items-center">
				<div class="banner-content col-lg-6 col-md-12 justify-content-center ">
					...
					<h1 class="wow fadeInUp" data-wow-duration="1s" data-wow-delay="1.7s">Abdrakhman Zhomart</h1>
				...
				<div class="banner-img col-lg-6 col-md-6 align-self-end">
					<img class="img-fluid" src="img/jomartjoma.png" alt="">
				</div>
			</div>
		</div>
	</section>
		...
		<div class="container">
			<div class="row align-items-center justify-content-between">
				<div class="col-lg-6 about-left">
					<img class="img-fluid" src="img/79saula.png.png" alt="">
				</div>
				<div class="col-lg-5 col-md-12 about-right">
					...
					<div class="mb-50 wow fadeIn" data-wow-duration=".8s">
						<p>
							My name is Zhomart and I am 19 years old. I was born on July 4, 2001, in the city of Shymkent. Shymkent is one of the largest cities in Kazakhstan, which is the capital of the CIS country.

I am a second-year student. I study as a programmer.
						</p>
						<p>Studying at SDU is difficult, but I do my best to become a good specialist.
						</p>
					</div>
	...
	<section class="contact-area section-gap">
		<div class="container">
			<div class="row">
				<div class="col-lg-12">
					<div class="contact-title">
						<h2>Contact Me</h2>
						<p>If you need any assistance whatsoever, please do not hesitate to let me know.</p>
					</div>
				</div>
			</div>
			...
			<div class="row mt-80">
				...
				<div class="col-lg-4 col-md-4">
					<div class="contact-box">
						<h4>1901032892@Stu.sdu.edu.kz</h4>
					</div>
				</div>
				<div class="col-lg-4 col-md-4">
					<div class="contact-box">
						<h4>Abdrakhman.Zhomart.me</h4>
					</div>
				</div>
			</div>
